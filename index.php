...
<div class="container-fluid">
	...
	<div class="row row_custom">
		...
		<div class="col-xs-offset-2 col-xs-6 to_see">
			<div class="col-xs-offset-0 col-xs-3  to_see_box"><br />
				<a href="#">À voir</a>
			</div>
			<div class="col-xs-offset-0 col-xs-9 to_see_text">
				<p>
	...
	<div class="row row_custom">
		...
		<div class="col-xs-offset-0 col-xs-6 pract">
			<div class="col-xs-offset-0 col-xs-9 pract_text">
				<p>
					Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
					tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
					quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
			...
			<div class="col-xs-offset-0 col-xs-3  pract_box"><br />
				<a href="#">Pratiquer</a>
			</div>
		</div>
	</div>
